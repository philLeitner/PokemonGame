...
public static class WeltData
{
    ...
    public static List<Ort> AlleOrte() => new()
    {
        ...
        new() {
            ...
            NPCs = new() {
                new() {
                    Id = "KAN-NPC-PRISMANIA-SPRUDEL", Name = "Direktor Hideo", Emoji = "👨‍💼",
                    Dialog = "Willkommen in der Silph AG! Als Dankeschoen fuer deine Hilfe erhaeltst du das Sprudelwasser – ein besonderes Getraenk, das dir Zugang zu Saffronia verschafft.",
                    GibtItemId = "sprudelwasser", GibtItemName = "Sprudelwasser", GibtItemEmoji = "💧",
                    DialogNachGeschenk = "Mit dem Sprudelwasser kannst du nun durch die Wachen in Saffronia gelangen!",
                },
            },
            Arena = new() {
        ...
        new() {
            ...
            Arena = new() {
                ...
                OrdenNr = 8, TypSpezialisierung = "Psycho",
